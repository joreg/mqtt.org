   ...
   <div class="panel">
      <div class="subhead">Web</div>
         ...
         <ul>
            ...
            <li><a href="https://vvvv.org">vvvv</a> - A visual live-programming environment for .NET with a dedicated plugin for easy handling of mqtt scenarios: <a href=https://www.nuget.org/packages/VL.IO.MQTT">VL.IO.MQTT</a></li> 
         </ul>
